...
module BitBucket
  class Repos::Hooks < API
    ...
    def list(user_name, repo_name, params={})
      ...
      response = get_request("/1.0/repositories/#{user}/#{repo.downcase}/hooks", params)
    ...
    def get(user_name, repo_name, service_id, params={})
      ...
      get_request("/1.0/repositories/#{user}/#{repo.downcase}/hooks/#{service_id}", params)
    end
    alias :find :get
    ...
    def create(user_name, repo_name, params={})
      ...
      post_request("/1.0/repositories/#{user}/#{repo.downcase}/hooks", params)
    end
    ...
    def edit(user_name, repo_name, service_id, params={})
      ...
      put_request("/1.0/repositories/#{user}/#{repo.downcase}/hooks/#{service_id}", params)
    end
    ...
    def delete(user_name, repo_name, service_id, params={})
      ...
      delete_request("/1.0/repositories/#{user}/#{repo.downcase}/hooks/#{service_id}", params)
    end
